    ...
    <xsl:template match="UpgradeLog">
        <html>
            <head>
                ...
                <link rel="stylesheet" href="_MigrationReport_Files\MigrationReport.css" />
                ...
                <script language="javascript">
                  ...
                  if (check.lastIndexOf("Migrationreport_plus.gif") != -1)
                  {
                  uMe.src = "_MigrationReport_Files/MigrationReport_Minus.gif"
                  }
                  else
                  {
                  uMe.src = "_MigrationReport_Files/MigrationReport_Plus.gif"
                  }
                  }
                </script>
            </head>
